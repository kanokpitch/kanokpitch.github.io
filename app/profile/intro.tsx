...
const About = () => {
  return (
    <div className='container-fluid pt-5 d-flex flex-column align-items-center min-vh-100'>
      ...
      <a href="./resume" target='_BLANK' className="btn btn-primary mt-5 custom-btn fw-bold">View My Resume</a>
      ...
      <p className='lead flex'>
        ...
        <Image className='m-2' src="https://cdn.cdnlogo.com/logos/n/49/node-js.svg" alt="git" width="40" height="40" />
        <Image className='m-2' src="https://cdn.cdnlogo.com/logos/g/31/github.svg" alt="git" width="40" height="40" />
        <Image className='m-2' src="https://cdn.cdnlogo.com/logos/m/25/mongodb.svg" alt="git" width="40" height="40" />
        <Image className='m-2' src="https://cdn.cdnlogo.com/logos/s/14/socket-io.svg" alt="git" width="35" height="35" />
