  ...
  return (
    <div className='container-fluid d-flex flex-column align-items-center min-vh-100'>
      ...
      <p className='lead flex flex-wrap'>
        ...
        <Image className='m-2' src="https://www.cdnlogo.com/logos/p/93/postgresql.svg" alt="postgresql" width="40" height="35" />
        <Image className='m-2' src="https://www.cdnlogo.com/logos/m/10/mysql.svg" alt="mysql" width="40" height="35" />
        ...
        <Image className='m-2' src="https://cdnlogo.com/logos/d/41/docker.svg" alt="docker" width="50" height="25" />
        <Image className='m-2' src="https://cdnlogo.com/logos/k/14/kubernetes.svg" alt="kubernetes" width="120" height="25" />
      </p>
